                  ...
                  <!-- OPCION 1 Cromos -->
                    ...
                    <!-- OPCION 2 Quinielas -->
                			<div class="col-sm-3 col-lg-3">
  	                        ...
  	                        <li><a class="tt" href="<?php echo e(url('/puntuacionesQui/1')); ?>"> Tabla de Posiciones Quiniela <span class="tooltip"><span class="triangle-obtuse"> Pronto habilitada esta opcion... </span></span></a></li>
                            <li>-</li>
