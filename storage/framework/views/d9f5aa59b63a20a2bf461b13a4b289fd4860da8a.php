         ...
         <?php $__currentLoopData = $misnoticias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $noticia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="col-md-4 wow fadeInUp">
            <div class="news-col">
              ...
              <a href="<?php echo e(route('news.show', $noticia->id)); ?>" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
              <?php if(auth()->user() != null && auth()->user()->hasRoles('Administrator')): ?>
                <a href="<?php echo e(route('news.edit', $noticia->id)); ?>" class="btn btn-success btn-sm" ><i class="fa fa-edit"></i></a>
              <?php endif; ?>
              
              <a href="whatsapp://send?text=<?php echo e($noticia['titulo']); ?> - <?php echo e(url('/news/'.$noticia['id'])); ?>" img src="img/notice/<?php echo e($noticia['name_img']); ?>" data-action="share/whatsapp/share" target="_blank" class="btn btn-success btn-sm" style="" ><i class="fa fa-whatsapp fa-sm">  Compartir</i></a>
              <!--
