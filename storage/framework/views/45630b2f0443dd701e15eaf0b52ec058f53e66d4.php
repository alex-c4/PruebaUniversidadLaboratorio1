            ...
            <div class="row align-items-center">
                ...
                <?php $__currentLoopData = $pronosticsDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pronostic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-12 text-center font-weight-light">
                        <span class="text-success">  <?php echo e($pronostic->date); ?> / <?php echo e($pronostic->estadium); ?>  </span> / <span class="font-weight-bold">Grupo <?php echo e($pronostic->grupo); ?> &nbsp; </span> <span id="actualizado_<?php echo e($pronostic->pronostic_id); ?>" class="text-info" style="size:8px"></span>
                    </div>
