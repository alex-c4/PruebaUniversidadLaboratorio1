      ...
      <![endif]-->
                  ...
                  <tr>
                    <td align="justify" style="font-size:0px;padding:20px 25px 25px 25px;word-break:break-word;">
                      <div style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:15px;line-height:1;text-align:justify;color:#ffffff;">A continuación le suministramos la clave de acceso, con la cual ud podrá acceder a nuestros portal:</div>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="justify" style="font-size:0px;padding:20px 25px 25px 25px;word-break:break-word;">
                      <div style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:15px;line-height:1;text-align:justify;color:#ffffff;">Una vez dentro, ud podrá modificar esta contraseña que le hemos asignado por otra que prefiera.</div>
                    </td>
                  </tr>
                  <tr>
