  ...
  <div style="background-color:#ffffff;">
                  ...
                  <tr>
                    <td align="right" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                        <tbody>
                          <tr>
                            <td style="width:100px;"> <img height="auto" src="http://test.xportgold.com/img/emailTemplate/useremail2.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="100" /> </td>
                          </tr>
                        </tbody>
                      </table>
                    </td>
    ...
    <div style="background:#2f2f2f;background-color:#2f2f2f;margin:0px auto;max-width:600px;">
      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#2f2f2f;background-color:#2f2f2f;width:100%;">
        <tbody>
          <tr>
            <td style="direction:ltr;font-size:0px;padding:20px 0;padding-bottom:40px;padding-top:40px;text-align:center;">
              <!--[if mso | IE]>
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
      ...
      <![endif]-->
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:50px 25px 25px 25px;word-break:break-word;">
                      <div style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:22px;line-height:1;text-align:left;color:#ffffff;">Bienvenido a XportGold.<br /><br /><br /><span style="color:#9E7622">Estimad@ </span>{{ ucfirst($name) }} {{ ucfirst($lastname) }}</div>
                    </td>
                  </tr>
                  <tr>
                    <td align="justify" style="font-size:0px;padding:20px 25px 25px 25px;word-break:break-word;">
                      <div style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:15px;line-height:1;text-align:justify;color:#ffffff;">El siguiente mensaje tiene como finalidad realizar las confirmación de su cuenta de correo electrónico, para ello simplemente deberá hacer click en el siguiente enlace:</div>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" vertical-align="middle" style="font-size:0px;padding:10px 25px;padding-top:20px;word-break:break-word;">
                      <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                        <tr>
                          <td align="center" bgcolor="#5FA91D" role="presentation" style="border:none;border-radius:2px;cursor:auto;mso-padding-alt:10px 25px;background:#5FA91D;" valign="middle"> <a href="{{ url('verify/' . $confirmation_code) }}" style="display:inline-block;background:#5FA91D;color:#ffffff;font-family:open Sans Helvetica, Arial, sans-serif;font-size:18px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:2px;"
                              target="_blank">
              ¡Confirmar correo!
            </a> </td>
                        </tr>
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:20px 25px 25px 25px;word-break:break-word;">
                      <div style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:15px;line-height:1;text-align:left;color:#ffffff;">Atentamente, <br /> El equipo de xportgold.</div>
                    </td>
                  </tr>
                </table>
              </div>
