        		...
        		<div id="register-wraper">
                   ...
                   {{ csrf_field() }}
                    ...
                    -->
        		        	...
        		        	<!-- Referencia de pago -->
    		        		<label for="surname">Codigo de Referencia de pago</label>
    		        		<input name="surname" class="input-huge" type="text" id="ref_pago" >
