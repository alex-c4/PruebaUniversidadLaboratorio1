<div id="smart-button-container">
      <div style="text-align: center;">
        <div style="margin-bottom: 1.25rem;">
          ...
          <select id="item-options"><option value="10 GOLD" price="10">10 GOLD - 10 USD</option><option value="20 GOLD" price="">20 GOLD -  USD</option></select>
    ...
    var orderDescription = 'Recarga de Saldo';
    if(orderDescription === '') {
